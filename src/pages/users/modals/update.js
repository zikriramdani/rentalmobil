...
function Update(props) {
	const { onClose, onShow, dataItem, setAlertSuccess, alertSuccess, setAlertError, alertError } = props;
  ...
  return (
    <ZRModals onClose={onClose} onShow={onShow}
        ...
        <button onClick={(e)=> handleUpdate(e)} type="button" className="btn btn-success" disabled={isLoading}>
